...
class Mage_Customer_Block_Account_Dashboard_Address extends Mage_Core_Block_Template
{
    ...
    public function getPrimaryShippingAddressHtml()
    {
        ...
        if( $address instanceof Varien_Object ) {
            ...
            return Mage::helper('customer')->__('No haz definido una dirección para envíos predeterminada.');
        }
    }
    ...
    public function getPrimaryBillingAddressHtml()
    {
        ...
        if( $address instanceof Varien_Object ) {
            ...
            return Mage::helper('customer')->__('No haz definido una dirección de facturación.');
        }
    }
